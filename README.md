...
- Using a more advanced firewall can bring an extra layer of security (and privacy), as you control each connection made by programs in real time. [Lulu](https://objective-see.org/products/lulu.html) is the main open source firewall on Macos, but [LittleSnitch](https://www.obdev.at/products/littlesnitch/index.html) is a more complete alternative (not open source). 
