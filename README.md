![macOS stable](https://badgen.net/badge/icon/MacOS%20Sequoia%2015.1.1?icon=apple&label) ![GitHub last commit](https://img.shields.io/github/last-commit/beerisgood/macOS_Hardening?label=last%20update%3A)
