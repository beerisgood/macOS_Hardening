![MacOS stable](https://badgen.net/badge/icon/MacOS%20Monterey%2012.2.1?icon=apple&label) ![Work in progress label](https://img.shields.io/badge/-Work%20in%20Progress-yellowgreen) ![GitHub last commit](https://img.shields.io/github/last-commit/beerisgood/macOS_Hardening?label=last%20update%3A)
...
- While DNS encryption [isn't perfect](https://madaidans-insecurities.github.io/encrypted-dns.html) both [NextDNS](https://nextdns.io/?from=qvnr8eu8) and [Quad9](https://www.quad9.net) are recommend. NextDNS provide a [easy solution](https://apple.nextdns.io/), Quad9 a [guide](https://support.quad9.net/hc/en-us/categories/360002571772-Configuration) for encrypted DNS. Beside malware, NextDNS also protects against ads, trackers and more.
