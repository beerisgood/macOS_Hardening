![MacOS stable](https://badgen.net/badge/icon/MacOS%20Ventura%2013.4.1(c)?icon=apple&label) ![GitHub last commit](https://img.shields.io/github/last-commit/beerisgood/macOS_Hardening?label=last%20update%3A)
