![MacOS stable](https://badgen.net/badge/icon/MacOS%20Ventura%2013.0.1?icon=apple&label) ![GitHub last commit](https://img.shields.io/github/last-commit/beerisgood/macOS_Hardening?label=last%20update%3A)
...
- use only Safari as browser, because it supports [PrivateRelay](https://support.apple.com/en-us/HT212614), [PassKeys](https://developer.apple.com/videos/play/wwdc2021/10106/) and offers the best collaboration in Apple cosmos
